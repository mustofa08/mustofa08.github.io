  ...
  // Fungsi untuk menampilkan halaman permainan setelah login berhasil
  function showGamePage() {
    document.getElementById("registration-page").style.display = "none";
    document.getElementById("login-page").style.display = "none";
    document.getElementById("game-page").style.display = "block";
    initializeWord(); // Panggil inisialisasi permainan di sini saat permainan dimulai.
  }
  ...
  function handleLogin(event) {
    event.preventDefault();
    showGamePage(); // Panggil fungsi untuk memulai permainan saat login berhasil.
  }

  // Panggil fungsi showRegistrationPage() saat halaman dimuat
